...
export function useMotorInteligencia() {
  ...
  const niveles = useMemo(
    ...
    [tareas, proyectos, habitos, estadoHoyHabitos, bandejaMental, decisiones, ingresos, gastos, objetivos, indices, hoy]
  );

  return {
    indices,
    niveles,
    datos: { tareas, proyectos, habitos, estadoHoyHabitos, areasDeVida, ingresos, gastos, hoy },
  };
}
