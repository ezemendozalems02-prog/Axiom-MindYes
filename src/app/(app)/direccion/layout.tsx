...
const TABS = [
  { href: "/direccion/vision", label: "Visión" },
  { href: "/direccion/objetivos", label: "Objetivos" },
  { href: "/direccion/metas", label: "Metas" },
  { href: "/direccion/plan-anual", label: "Plan Anual" },
  { href: "/direccion/plan-semanal", label: "Plan Semanal" },
  { href: "/direccion/revision-mensual", label: "Revisión Mensual" },
  { href: "/direccion/roadmaps", label: "Roadmaps" },
];
